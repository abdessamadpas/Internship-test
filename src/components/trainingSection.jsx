...
import { IoClose } from "react-icons/io5";function TrainingSection() {
  return (
    <div className='flex flex-col items-center justify-center gap-3 '>
        ...
        {/* 1 section */}
        <div className='grid grid-cols-1 lg:grid-cols-[50%,auto,20%] md:grid-cols-[70%,auto] gap-4 justify-around w-full'>
            {/* left section */}    
        ...
        {/* 2 section */}
        <div className='border-[#FFFFFF] border-2 p-3 rounded-lg bg-white shadow-md w-full px-3 py-3'>
            <div className=''>
            ...
            <hr className='my-3'/>
            <div className= ' grid grid-cols-1 lg:grid-cols-[50%,auto] md:grid-cols-[70%,auto] rounded-md px-7 py-6 bg-[#F8F8F8] w-full'>
